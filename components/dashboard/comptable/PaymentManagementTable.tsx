...
import { ChevronLeft, ChevronRight, Check, Eye, SearchX } from 'lucide-react';
                  ...
                  <td colSpan={10} className="py-24 text-center">
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <h4 className="text-2xl font-bold text-sky-900 font-montserrat tracking-tight">Aucun paiement trouvé</h4>
                        <p className="text-xl text-stone-400 font-montserrat tracking-tight">Il n'y a actuellement aucun paiement à afficher.</p>
                      </div>
                    </motion.div>
                  </td>
                </tr>
