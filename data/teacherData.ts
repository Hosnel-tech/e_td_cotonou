...
export const TEACHER_DATA: Teacher[] = [
  ...
  { 
    ...
    email: 'elvire.tossou@example.com',
  ...
  { 
    ...
    email: 'jacques.migan@example.com',
  ...
  { 
    ...
    email: 'felicite.boko@example.com',
    phone: '01 22 11 00 99',
    birthDate: '12-12-1995',
    nationality: 'Béninoise',
    location: 'Cotonou, Sènadé',
    ifu: '66778899',
  ...
  { 
    id: '11', 
    name: 'AHOUANDJINOU Pierre', 
    subject: 'Informatique', 
    className: 'Tle D', 
    date: '05/03/26', 
    status: 'actif', 
    school: 'Lycée Béhanzin',
    email: 'pierre.a@example.com',
  ...
  { 
    ...
    date: '15/03/26', 
    status: 'en attente', 
    school: 'EFE Montaigne',
    email: 'geraud.v@example.com',
